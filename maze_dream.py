...
def wall_locations_gradient(wall_locations: torch.Tensor,
    ...
    """
    A function that calculates the gradient of wall_locations relative to our desired Q-value,
    i.e. how much we should modify our wall_locations values to maximize the Q-value associated
    with taking the movement movement_idx
    ...
    :param pos:
    :param movement_idx: one of the indices defined in main_train. Either
    :param model:
    :return:
    """
    ...
    # TODO: What should the requires_grad setting be for my other entries?
    # Fill in code here
    ...
    # TODO: I've now the run the model. How do I backpropagate and get the gradient I want?
    # You should use movement_idx here
